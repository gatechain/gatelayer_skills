...
[Agent Skills](https://agentskills.io) for building on [GateLayer](https://www.gatechain.io/docs/zh/GateLayer/Introduction/). These skills enable AI agents to connect to GateLayer, deploy contracts, and interact with the network.
...
| [Deploying Contracts on GateLayer](./skills/deploying-contracts-on-gatelayer/SKILL.md) | Deploys and verifies contracts on GateLayer with Foundry, plus common troubleshooting guidance. |
...
```text
Deploy my contract on GateLayer
```
